...
import eif.viko.lt.gposkaite.myFarm.data.Employees.EmployeeDatabase
...
class EmployeesActivity : ComponentActivity() {
        ...
        factoryProducer = {
            object : ViewModelProvider.Factory {
                override fun <T : ViewModel> create(modelClass: Class<T>): T {
                    return EmployeeViewModel(database.dao) as T
                }
            }
        }
    )
                        ...
                        TopAppBar(
                            ...
                            navigationIcon = {
                                IconButton(
                                    ...
                                    Icon(imageVector = Icons.Default.Menu, contentDescription = stringResource(id = R.string.employees))
                                }
                            }
                        )
                    },
    ...
    fun MyFarmContent() {
        androidx.compose.material3.Surface(
            ...
            NavHost(navController = navController, startDestination = "EmployeesScreen") {
